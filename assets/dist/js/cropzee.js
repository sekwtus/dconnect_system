...
var dependencies =
    '<!-- light-modal -->'
    + '<link href=light-modal.min.css" rel="stylesheet">'
    + '<!-- animate.css -->'
    + '<link href=animate.min.css" rel="stylesheet">'
    + '<!-- canvas-toBlob.js -->'
    + '<script src="/assets/dist/js/canvas-toBlob.min.js" defer></script>'
    + '<!-- FileSaver.js -->'
    + '<script src="/assets/dist/js/FileSaver.min.js" defer></script>'
    + '<!-- Croppr.js -->'
    + '<link href=croppr.min.css" rel="stylesheet">'
    + '<script src="/assets/dist/js/croppr.min.js"></script>';
