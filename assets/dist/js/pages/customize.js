...
function repeater(index) {
  ...
  $(".repeater123" + index).repeater({
    ...
    ready: function (setIndexes) {
      $.each($(".seam" + index), function (index1, value) {
        $(
          "input[name*='page-group-default" + index + "[" + index1 + "][note]"
        ).dropify();
      });
    },
    ready: function (setIndexes) {
      ...
      $.each($(".seam" + index), function (index1, value) {
        $(
          "input[name*='page-group" + index + "[" + index1 + "][note]"
        ).dropify();
      });
    },
  });
...
$("#btn-add-page").click(function () {
  ...
  $(".tab-content").append(
    '\
      ...
      '" class="dropify" data-default-file="" />\
                    ...
                    <div class="col-md-12">\
                        <div class="form-group row">\
                            <label for="time_roll' +
      index +
      '" class="col-sm-12 col-form-label">เวลาที่เปลี่ยนม้วน</label>\
                            <div class="col-sm-12">\
      ...
      index +
      '" class="col-sm-12 col-form-label">จำนวนซองที่ผลิตได้</label>\
                            <div class="col-sm-12">\
      ...
      index +
      '" class="col-sm-12 col-form-label">เครื่องบรรจุที่</label>\
                            <div class="col-sm-12">\
      ...
      '">\
                    ...
                    <div class="col-md-12 text-right">\
                        <div class="form-group row">\
                            <div class="col-sm-12">\
                                โดย<button type="button" class="btn btn-primary" data-toggle="modal"\
                                    data-target="#modelId" data-input="by' +
      index +
      '">กดเพื่อบันทึกลายเซ็น</button>\
      ...
      '"\
                    ...
                    <div class="col-md-12">\
                        <div class="form-group row">\
                            <label for="count_seam" class="col-sm-12 col-form-label">จำนวนรอยต่อ</label>\
                            <div class="col-sm-12">\
      ...
      index +
      '[0][time_roll]"\
                                            class="col-sm-12 col-form-label">เวลาที่ม้วน</label>\
                                        <div class="col-sm-12">\
...
$(document).ready(function () {
  droptify();
  for (let index2 = 0; index2 < $("#page").val(); index2++) {
    repeater(index2);
  }
});
