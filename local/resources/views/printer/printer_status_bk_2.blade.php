                    ...
                    <tbody>
                        ...
                        <tr style="font-size: 13px;">
                            <td>
                                ...
                                <div class="row">
                                    <div class="col-7 text-left">
                                        @if (empty($FM_PD_018_1[0]->status) || $FM_PD_018_1[0]->status == NULL  || $FM_PD_018_1[0]->status == 2)
                                                <a>FM-PD-018-1</a>
                                            @endif
                                            @if (!empty($FM_PD_018_1[0]->status) && $FM_PD_018_1[0]->status == 1)
                                    ...
                                    <div class="col-5 text-center">
                                        ...
                                        @else
                                            ...
                                            <input type="text" name="production_order" value="{{$order}}" hidden>
                            ...
                            <td>
                                ...
                                <div class="row">
                                    <div class="col-7 text-left">
                                        @if (empty($FM_PD_132[0]->status) || $FM_PD_132[0]->status == NULL  || $FM_PD_132[0]->status == 2)
                                        <a >FM-PD-132</a>
                                        @endif
                                        @if (!empty($FM_PD_132[0]->status) && $FM_PD_132[0]->status == 1)
                                ...
                                <div class="row mt-1">
                                    <div class="col-7 text-left">
                                            @if (empty($FM_PD_044[0]->status) || $FM_PD_044[0]->status == NULL  || $FM_PD_044[0]->status == 2)
                                                <a >FM-PD-044</a>
                                            @endif
                                            @if (!empty($FM_PD_044[0]->status) && $FM_PD_044[0]->status == 1)
                                ...
                                <div class="row mt-1">
                                    <div class="col-7 text-left">
                                        @if (empty($FM_PD_037[0]->status) || $FM_PD_037[0]->status == NULL  || $FM_PD_037[0]->status == 2)
                                            <a>FM-PD-037</a>
                                        @endif
                                        @if (!empty($FM_PD_037[0]->status) && $FM_PD_037[0]->status == 1)
                                ...
                                <div class="row mt-1">
                                    <div class="col-7 text-left">
                                        @if (empty($FM_PD_018_2[0]->status) || $FM_PD_018_2[0]->status == NULL  || $FM_PD_018_2[0]->status == 2)
                                            <a>FM-PD-018-2</a>
                                        @endif
                                        @if (!empty($FM_PD_018_2[0]->status) && $FM_PD_018_2[0]->status == 1)
                            ...
                            <td>
                                ...
                                <div class="row">
                                    <div class="col-7 text-left">
                                        @if (empty($FM_PD_002[0]->status) || $FM_PD_002[0]->status == NULL  || $FM_PD_002[0]->status == 2)
                                            <a>FM-PD-002</a>
                                        @endif
                                        @if (!empty($FM_PD_002[0]->status) && $FM_PD_002[0]->status == 1)
                                ...
                                <div class="row mt-1">
                                    <div class="col-7 text-left">
                                        @if (empty($FM_PD_018_3[0]->status) || $FM_PD_018_3[0]->status == NULL  || $FM_PD_018_3[0]->status == 2)
                                            <a >FM-PD-018-3</a>
                                        @endif
                                        @if (!empty($FM_PD_018_3[0]->status) && $FM_PD_018_3[0]->status == 1)
                            ...
                            <td>
                                ...
                                <div class="row">
                                    <div class="col-7 text-left">
                                        @if (empty($FM_PD_034[0]->status) || $FM_PD_034[0]->status == NULL  || $FM_PD_034[0]->status == 2)
                                            <a >FM-PD-034</a>
                                        @endif
                                        @if (!empty($FM_PD_034[0]->status) && $FM_PD_034[0]->status == 1)
                                ...
                                <div class="row mt-1">
                                    <div class="col-7 text-left">
                                        @if (empty($FM_PD_131[0]->status) || $FM_PD_131[0]->status == NULL  || $FM_PD_131[0]->status == 2)
                                            <a >FM-PD-131</a>
                                        @endif
                                        @if (!empty($FM_PD_131[0]->status) && $FM_PD_131[0]->status == 1)
                                ...
                                <div class="row mt-1">
                                    <div class="col-7 text-left">
                                        @if (empty($FM_PD_130[0]->status) || $FM_PD_130[0]->status == NULL  || $FM_PD_130[0]->status == 2)
                                            <a >FM-PD-130</a>
                                        @endif
                                        @if (!empty($FM_PD_130[0]->status) && $FM_PD_130[0]->status == 1)
                                ...
                                <div class="row mt-1">
                                    <div class="col-7 text-left">
                                        @if (empty($FM_PD_024[0]->status) || $FM_PD_024[0]->status == NULL  || $FM_PD_024[0]->status == 2)
                                            <a >FM-PD-024</a>
                                        @endif
                                        @if (!empty($FM_PD_024[0]->status) && $FM_PD_024[0]->status == 1)
                            ...
                            <td>
                                ...
                                <div class="row mt-1">
                                    <div class="col-7 text-left">
                                        @if (empty($FM_PD_014[0]->status) || $FM_PD_014[0]->status == NULL  || $FM_PD_014[0]->status == 2)
                                            <a >FM-PD-014</a>
                                        @endif
                                        @if (!empty($FM_PD_014[0]->status) && $FM_PD_014[0]->status == 1)
