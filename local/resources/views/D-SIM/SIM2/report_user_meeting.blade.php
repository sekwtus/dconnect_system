    ...
    <div class="col-md-12 px-0">
        <div class="card">
            <div class="card-body">
                <div class="row"> 
                    <div class="col-md-4">
                        <h4 class="card-title">SIM3 </h4>
                        <h6 class="card-subtitle">รายงานผู้เข้าร่มประชุมประจำวัน</h6>
                    </div>
...
<script>
    ...
    function datatable(date_spec){
        var table =  $('#order_table').DataTable( {
            ...
            // serverSide: true,
            ajax: {
                url: '{{ url('/sim2/report_user_meeting/getAjax') }}',
                data: {date_spec:date_spec,department_id:department_id},
                complete: function(){
