        ...
        <div class="card">
            ...
            <div class="card-body">
                <center class="m-t-10">
                    ...
                    <img src="{{ asset('/assets/profile'.'/'. $out_users->pic_profile)}}" class="img-circle"
                        width="150" />
                    @else
        ...
        <div class="card">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane" id="settings" role="tabpanel">
                    <div class="card-body">
                        {{ Form::open(['method' => 'POST' , 'url' => 'profile/save', 'files' => true, 'class' => 'form-horizontal form-material']) }}
                        @foreach ($users as $out_users)
                        <div class="form-group">
                            <label class="col-md-12">Full Name</label>
                            <div class="col-md-12">
                                <input type="text" placeholder="ชือ - สกุล" class="form-control form-control-line"
                                    name="name" value="{{ $out_users->name }}">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="example-email" class="col-md-12">Email</label>
                            <div class="col-md-12">
                                <input type="email" placeholder="อีเมล" class="form-control form-control-line"
                                    name="email" id="example-email" value="{{ $out_users->email }}">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="text" placeholder="Username" class="form-control form-control-line"
                                    name="username" value="{{ $out_users->username }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="text" placeholder="เบอร์โทร" class="form-control form-control-line"
                                    name="phone" value="{{ $out_users->phone }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="text" placeholder="ที่อยู่" class="form-control form-control-line"
                                    name="address" value="{{ $out_users->address }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <select class="form-control custom-select" id="type_user" name="type_user"
                                    onchange="eventtypeuser(this.value)">
                        ...
                        <div class="form-group hide" id="type_branch">
                            ...
                            <div class="col-md-12">
                                <select class="form-control custom-select" id="type_branch" name="type_branch">
                                    ...
                                    <option value="{{ $out_users->id_type_branch  }}">{{ $out_users->type_branch }}
                                    </option>
                                    @endif
                                    @foreach ($type_branch as $out_type_branch)
                                    @if($out_users->id_type_branch != $out_type_branch->id)
                                    <option value="{{ $out_type_branch->id  }}">{{ $out_type_branch->type_branch }}
                                    </option>
                                    @endif
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                ...
                                data-default-file="{{ !empty($out_users->pic_profile) ? asset('/assets/profile/'.$out_users->pic_profile) : null }}" />
                            </div>
                        </div>

                        <div class="form-group">
                            <label class="col-md-12">Picture Signature</label>
                            <div class="col-md-12">
                                <input type="file" id="sign_photo" class="dropify" name="sign_photo"
                                    data-default-file="{{ !empty($out_users->sign_photo) ? asset('/assets/images/sign/'.$out_users->sign_photo) : null }}" />
                            </div>
                        </div>
                        {{-- <div class="form-group">
