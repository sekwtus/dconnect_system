    ...
    <nav class="navbar top-navbar navbar-expand-md navbar-dark">
        ...
        <div class="navbar-header">
            <a class="navbar-brand" href="#">
                ...
                <b>
                    ...
                    <!-- Dark Logo icon -->
                    {{-- {{ asset(Config::get('app.icon')) }} --}}
                    <img src="{{ asset(Config::get('app.icon')) }}" style="width:40px; height:40px;"class="dark-logo" />
                    <!-- Light Logo icon -->
                    <img src="{{ asset(Config::get('app.icon')) }}" style="width:40px; height:40px;" class="light-logo" />
                </b>
                
                <!-- Logo text -->
                <span>
                    <!-- dark Logo text -->
                    <img src="{{ asset(Config::get('app.logo_navbar')) }}" style="width:135px; height:50px;" class="dark-logo" />
                    <!-- Light Logo text -->
                    <img src="{{ asset(Config::get('app.logo_navbar')) }}" style="width:135px; height:50px;" class="light-logo" />
                </span>
            </a>
        </div>
        <!-- ============================================================== -->
        ...
        <div class="navbar-collapse">
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <h3 class="nav-link" style="font-weight:bold; color: black;" ><span id="showSetWeek"></span></h3>
                </li>
            </ul>

            <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                    <h3 class="nav-link" style="font-weight:bold; color: black;" ><span id="showHeader"></span></h3>
                </li>
            </ul>
            ...
            <ul class="navbar-nav my-lg-0">
                ...
                <li class="nav-item">
                    <div id="countdown_div" class="nav-link" style="width: 114.5px;margin-left:auto;color: black;padding-bottom: 0px;padding-top: 0px;border-top-width: 0px;margin-top: 10px;" ></div>
                </li>
                <li class="nav-item" style="text-align: -webkit-match-parent;">
                    <h3 class="nav-link" style="font-weight:bold; color: black;" ><span id="showTextTime"></span></h3>
                </li>
                ...
                <li class="nav-item dropdown u-pro">
                    <a class="nav-link dropdown-toggle waves-effect waves-dark profile-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        @if(Auth::user()->pic_profile != NULL)
                            <img src="{{ asset('/assets/profile'.'/'. Auth::user()->pic_profile)}}" alt="user" class="">
                        @else
                            <img src="{{ asset('/assets/images/user.jpg')}}" alt="user" class="">
                        @endif
                        <span class="hidden-md-down">
                        {{ Auth::user()->name }} &nbsp;
                        <i class="ti-angle-down"></i></span> </a>
                    <div class="dropdown-menu dropdown-menu-right animated flipInY">
                        <a href="{{url('/order_table')}}" class="dropdown-item"><i class="ti-layout-grid2"></i> &nbsp;&nbsp;D-Link</a>
                        <!-- text-->
                        <a href="{{url('/profile')}}" class="dropdown-item"><i class="icon-user"></i> &nbsp;&nbsp;Profile</a>
                        <!-- text-->
                        <a href="{{url('/logout')}}" class="dropdown-item"><i class="icon-logout"></i>  &nbsp;&nbsp;Logout</a>
                        <!-- text-->
                    </div>
                </li>
                <!-- ============================================================== -->
