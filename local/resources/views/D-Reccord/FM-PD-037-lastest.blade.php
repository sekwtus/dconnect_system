...
@section('main')
<form method="POST" action="{{ url('/FM-PD-037/update_lastest/'.$sheet. '/' .$order ) }}" enctype="multipart/form-data">
    @csrf
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control" id="number_foil" name="number_foil" readonly
                                value="{{ !empty($FM_PD_037_main->number_foil) ? $FM_PD_037_main->number_foil : null }}" >
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group row">
                                ...
                                <div class="col-md-12">
                                    <input type="file" id="tag_foil" class="dropify" name="tag_foil"
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12">
                                    <input class="form-control" type="time" name="time_roll" id="time_roll" readonly
                                    value="{{ !empty($FM_PD_037_main->time_roll) ? $FM_PD_037_main->time_roll : null }}">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 ">
                                    ...
                                    value="{{ !empty($FM_PD_037_main->number_pack) ? $FM_PD_037_main->number_pack : null }}">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" id="machine_pack" name="machine_pack" value="{{ !empty($FM_PD_037_main->machine_pack) ? $FM_PD_037_main->machine_pack : null }}" readonly>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12">
                                    <input class="form-control" type="text" name="number_seam" id="number_seam"
                                    value="{{ !empty($FM_PD_037_main->number_seam) ? $FM_PD_037_main->number_seam :  null }}">
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="input-group">
                                                            <label class="container">ถูกต้อง
                                                                <input type="checkbox" id="correct1"  name="correct1" value="correct" onclick='{{ !empty($FM_PD_037_main->correct1) ? "return false" :"set_time(this,`time_roll1`)" }}'  onchange="CheckOnlyOne(this)"
                                                                {{ $FM_PD_037_main->correct1 == 'correct' ? 'checked' : '' }}    >
                                                                <span class="checkmark"></span>
                                                            </label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="input-group">
                                                            <label class="container">ไม่ถูกต้อง
                                                                <input type="checkbox" id="correct1"  name="correct1" value="incorrect" onclick='{{ !empty($FM_PD_037_main->correct1) ? "return false" :"set_time(this,`time_roll1`)" }}'  onchange="CheckOnlyOne(this)"
                                                                {{ $FM_PD_037_main->correct1 == 'incorrect' ? 'checked' : '' }}  {{ !empty($FM_PD_037_main->correct1) ? 'readonly' : '' }} >
                                                                <span class="checkmark"></span>
                                                            </label>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-12">
                                                <textarea class="form-control" name="note1" id="note1" rows="3">{{ !empty($FM_PD_037_main->note1) ? $FM_PD_037_main->note1 :  null }}</textarea> 
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            <label for="time_roll1" class="col-md-12 col-form-label"> เวลา </label>
                                            <div class="col-md-4">
                                                <input class="form-control"  min="00:00" max="24:00" type="time" id="time_roll2" name="time_roll2" readonly
                                            ...
                                            <div class="col-md-6">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="input-group">
                                                            <label class="container">ถูกต้อง
                                                                <input type="checkbox" id="correct2"  name="correct2" value="correct" onclick='{{ !empty($FM_PD_037_main->correct2) ? "return false" :"set_time(this,`time_roll2`)" }}'  onchange="CheckOnlyOne(this)"
                                                                {{ $FM_PD_037_main->correct2 == 'correct' ? 'checked' : '' }}    >
                                                                <span class="checkmark"></span>
                                                            </label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="input-group">
                                                            <label class="container">ไม่ถูกต้อง {{ !empty($FM_PD_037_main->correct2) ? 'return false' : `set_time(this,'time_roll2')` }}
                                                                <input type="checkbox" id="correct2"  name="correct2" value="incorrect" onclick='{{ !empty($FM_PD_037_main->correct2) ? "return false" :"set_time(this,`time_roll2`)" }}'  onchange="CheckOnlyOne(this)"
                                                                {{ $FM_PD_037_main->correct2 == 'incorrect' ? 'checked' : '' }}  {{ !empty($FM_PD_037_main->correct2) ? 'readonly' : '' }} >
                                                                <span class="checkmark"></span>
                                                            </label>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            <label for="page-group[0][note]"
                                                class="col-sm-12 col-form-label">หมายเหตุ</label>
                                            <div class="col-sm-12">
                                                <textarea class="form-control" name="note2" id="note2" rows="3">{{ !empty($FM_PD_037_main->note2) ? $FM_PD_037_main->note2 :  null }}</textarea> 
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            <label for="time_roll1" class="col-md-12 col-form-label"> เวลา </label>
                                            <div class="col-md-4">
                                                <input class="form-control"  min="00:00" max="24:00" type="time" id="time_roll3" name="time_roll3" readonly
                                            ...
                                            <div class="col-md-6">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="input-group">
                                                            <label class="container">ถูกต้อง
                                                                <input type="checkbox" id="correct3"  name="correct3" value="correct" onclick='{{ !empty($FM_PD_037_main->correct3) ? "return false" :"set_time(this,`time_roll3`)" }}'  onchange="CheckOnlyOne(this)"
                                                                {{ $FM_PD_037_main->correct3 == 'correct' ? 'checked' : '' }}    >
                                                                <span class="checkmark"></span>
                                                            </label>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="input-group">
                                                            <label class="container">ไม่ถูกต้อง
                                                                <input type="checkbox" id="correct3"  name="correct3" value="incorrect" onclick='{{ !empty($FM_PD_037_main->correct3) ? "return false" :"set_time(this,`time_roll3`)" }}'  onchange="CheckOnlyOne(this)"
                                                                {{ $FM_PD_037_main->correct3 == 'incorrect' ? 'checked' : '' }}  {{ !empty($FM_PD_037_main->correct3) ? 'readonly' : '' }} >
                                                                <span class="checkmark"></span>
                                                            </label>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            <label for="page-group[0][note]"
                                                class="col-sm-12 col-form-label">หมายเหตุ</label>
                                            <div class="col-sm-12">
                                                <textarea class="form-control" name="note3" id="note3" rows="3">{{ !empty($FM_PD_037_main->note3) ? $FM_PD_037_main->note3 :  null }}</textarea> 
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="row text-center">
                        <div class="col-md-12">
                            ...
                            <br> ( {{ isset($FM_PD_037_main->name) ? $FM_PD_037_main->name : null }} )
                        </div>
                    </div> 
                    ...
                    <div class="row text-center">
                        <div class="col-lg-6 col-md-6">
                            <button id="btn-check" class="btn btn-lg btn-block btn-success">
